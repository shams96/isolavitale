...
export default function ProductActions({ fullPrice, refillPrice, subscriptionPrice, product }: ProductActionsProps) {
  const [purchaseType, setPurchaseType] = useState('one-time');
  const [vesselType, setVesselType] = useState('full');
