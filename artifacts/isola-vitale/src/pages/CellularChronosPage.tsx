      ...
      <div className={styles.container}>
        <FadeIn>
          <div className={styles.header}>
            <span className={styles.label}>Cellular Chronos Collection</span>
            <h1 className={styles.title}>Age-Specific Precision Skincare</h1>
            <p style={{ fontFamily: 'var(--font-sans)', opacity: '0.8', maxWidth: '600px', margin: '2rem auto 0', lineHeight: '1.6', textAlign: 'center' }}>
