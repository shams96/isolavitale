        ...
        {articles.map(article => (
          <article key={article.id} className={styles.article}>
            <div className={styles.imageContainer}>
              <img src={article.imageSrc} alt={article.title} style={{ position: 'absolute', inset: 0, width: '100%', height: '100%', objectFit: 'cover' }} className={styles.image} />
            </div>
