    ...
    return (
        <main style={{ backgroundColor: 'var(--color-ivory)', minHeight: '100vh', color: 'var(--color-obsidian)' }}>
            <div style={{ position: 'relative', height: '60vh', width: '100%' }}>
                <Image src="/chiarelle-tech.png" alt="Chiarelle Intelligence" fill style={{ objectFit: 'cover' }} />
                <div style={{ position: 'absolute', bottom: '10%', left: '5%', color: 'var(--color-ivory)', zIndex: 10 }}>
                    <h2 style={{ fontFamily: 'var(--font-sans)', fontSize: '0.9rem', textTransform: 'uppercase', letterSpacing: '0.15em', marginBottom: '1rem' }}>Chiarelle Skin Intelligence</h2>
                ...
                <FadeIn>
                    <section style={{ marginBottom: '6rem' }}>
                        ...
                        <p style={{ fontFamily: 'var(--font-serif)', fontSize: '2rem', lineHeight: '1.4' }}>
                            Chiarelle is not an ingredient. It is a communication system. A bio-adaptive complex designed to read micro-signals from the skin structure and respond with precise intervention.
                        </p>
                    </section>
                </FadeIn>
                    ...
                    <section>
                        ...
                        <div style={{ display: 'flex', gap: '2rem', borderTop: '1px solid rgba(10,10,10,0.1)', paddingTop: '2rem' }}>
                            <p style={{ fontFamily: 'var(--font-sans)', opacity: '0.8', lineHeight: '1.6', flex: 1 }}>
                                Traditional skincare forces the skin to adapt to the product. Chiarelle adapts to the skin. This ensures maximum tolerance and long-term resilience without the cycle of inflammation.
                            </p>
                            <p style={{ fontFamily: 'var(--font-sans)', opacity: '0.8', lineHeight: '1.6', flex: 1 }}>
